...
class PrefetchGenerator(threading.Thread):
    r"""A fast data prefetch generator.
...
class PrefetchDataLoader(torch.utils.data.DataLoader):
    r"""A fast data prefetch dataloader.
...
class CPUPrefetcher:
    r"""Use the CPU side to accelerate data reading.
...
class CUDAPrefetcher:
    r"""Use the CUDA side to accelerate data reading.
